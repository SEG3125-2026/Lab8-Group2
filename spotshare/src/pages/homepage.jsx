    ...
    <div style={{ minHeight: '100vh', background: '#f9fafb' }}>
        ...
        >
          ...
          >
            ...
            <span style={{ color: '#6ee7b7', fontSize: 13, fontWeight: 500 }}>
              Now available near 50+ universities
            </span>
          </div>
          ...
          >
            ...
            <br />
            <span style={{ color: '#34d399' }}>Park Smarter.</span>
          </h1>
          ...
          >
            SpotShare connects commuter students with homeowners who have unused
            driveway space near campus.
          </p>
          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="Enter your university or campus name..."
              />
            </div>
            <Btn
              onClick={() => nav('search')}
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '80px 24px' }}>
        ...
        <p style={{ textAlign: 'center', color: '#6b7280', marginBottom: 60 }}>
          Three simple steps to never worry about campus parking
        </p>
          ...
          {[
            {
              ...
              desc: 'Enter your university and find available spots nearby. Filter by price, distance, and availability.',
            },
            {
              n: '02',
              emoji: '📅',
              title: 'Book Instantly',
              desc: 'Reserve your spot in minutes. Pay securely online and receive instant booking confirmation.',
            },
            {
              n: '03',
              emoji: '🚗',
              title: 'Park with Ease',
              desc: 'Get directions and parking instructions from your host. Enjoy stress-free commuting.',
            },
          ].map((s) => (
            <div
              key={s.n}
