...
import { LISTINGS, UPCOMING_BOOKINGS, PAST_BOOKINGS, COLORS } from '../data/listings.js'

const { green, lightGreen } = COLORS

export default function StudentDashboard({ nav, savedListings, toggleSave, messages, setMessages }) {
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '24px' }}>
        ...
        >
          <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
            ...
            <div>
              <p style={{ fontSize: 12, color: '#6b7280' }}>Welcome back 👋</p>
              <p style={{ fontWeight: 800, fontSize: 20, color: '#111' }}>Alex Chen</p>
            </div>
          </div>
        ...
        >
          {[
            ['4', 'Bookings this month', Car],
            ['28', 'Hours parked', Clock],
            ['$112', 'Money saved vs permit', DollarSign],
            ['4 min', 'Avg walk time', MapPin],
          ].map(([val, label, Icon]) => (
            <div
              key={label}
              style={{
